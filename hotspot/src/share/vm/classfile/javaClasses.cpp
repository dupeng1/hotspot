...
oop java_lang_Class::create_mirror(KlassHandle k, Handle protection_domain, TRAPS) {
  ...
  if (SystemDictionary::Class_klass_loaded()) {
    ...
    if (k->oop_is_array()) {
      ...
      // ≥ı ºªØ±æµÿæ≤Ã¨◊÷∂Œ£¨æ≤Ã¨◊÷∂Œ¥Ê¥¢‘⁄java.lang.Klass∂‘œÛ÷–
...
oop java_lang_ClassLoader::non_reflection_class_loader(oop loader) {
  if (loader != NULL) {
	...
	//sun.reflect.DelegatingClassLoaderÁª´ËØ≤Êπ™jdk\src\share\classes\sun\reflect\ClassDefiner.java
...
void javaClasses_init() {
  // ÂØπjavaËÆ°ÁÆóÂæóÂà∞classÊñá‰ª∂‰∏≠ÂêÑ‰∏™Á±ªÁöÑÂÅèÁßªÈáè
  JavaClasses::compute_offsets();
  // ËøõË°å‰∫ÜÊ†°È™?
  JavaClasses::check_offsets();
  // Ê†πÊçÆÂ∏∏ÈáèÊ±†ÁöÑÂÅèÁßªÈáèÊääclassÊñá‰ª∂‰∏≠ÁöÑÂ∏∏ÈáèÂÄºÊîæÂÖ•Ê±†‰∏?,Ëá≥Ê≠§Â∏∏ÈáèÊ±†ÁîüÊà?
